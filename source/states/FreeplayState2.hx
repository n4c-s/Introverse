...
{
    private var songs:Array<SongMetadata2> = [];
	...
	var player:MusicPlayer;
        ...
        override function create()
        {
	        ...
	        #if desktop
	        Lib.application.window.title = 'Introverse Mod: Vault: Good Ol` Times';
	        #end
			...
			var versionShit:FlxText = new FlxText(12, FlxG.height - 512, 1250, "Good ol' times");
