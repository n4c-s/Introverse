...
class FreeplayState5 extends MusicBeatState
{
    private var songs:Array<SongMetadata5> = [];
	...
	var player:MusicPlayer;
        ...
        override function create()
        {
		    ...
		    #if desktop
		    Lib.application.window.title = 'Introverse Mod: Vault: Depressive Cases';
		    #end
			...
			var versionShit:FlxText = new FlxText(12, FlxG.height - 512, 1250, "Depressive Cases");
