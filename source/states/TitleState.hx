...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		if(ClientPrefs.data.checkForUpdates && !closedState) {
			...
			var http = new haxe.Http("https://raw.githubusercontent.com/Nachocsp/Introverse/main/gitVersion.txt");

			http.onData = function (data:String)
			{
				updateVersion = data.split('\n')[0].trim();
				var curVersion:String = MainMenuState.introverseVersion.trim();
	...
	function startIntro()
	{
		...
		switch(easterEgg.toUpperCase())
		{
			...
			//EDIT THIS ONE IF YOU'RE MAKING A SOURCE CODE MOD!!!!
				...
				gfDance.animation.addByPrefix('danceLeft', 'God Eater Spin', 24, false);
				gfDance.animation.addByPrefix('danceRight', 'God Eater Spin', 24, false);
		}
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					createCoolText(['n4c', 'Julibros', 'and the', 'Natunatic Team']);
				case 4:
					addMoreText('present');
				case 5:
					deleteCoolText();
				...
				case 16:
					addMoreText('Introverse mod'); // credTextShit.text += '\nFunkin';
