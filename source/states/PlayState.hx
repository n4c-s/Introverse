...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		if (FlxG.random.bool(0.2))
			{
				Lib.application.window.title = "playin " + nombreCancion + " huh? good choice";
			}
			else
			{
		...
		switch (curStage)
		{
			...
			case 'crazyStage': new states.stages.CrazyStage(); // Demo - CrAzY StAgE
		}
	...
	override function closeSubState()
	{
		...
		if (paused)
		{
			...
			{
				resyncVocals();
				Lib.application.window.title = tituloekisde + nombreCancion;
			}
